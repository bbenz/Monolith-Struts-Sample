...
> This file is the OpenAI Codex / Agents equivalent of `.github/copilot-instructions.md`. It is automatically loaded by Codex CLI when working in this repository. Task-specific prompts are in the `prompts/` directory.
