...
> This file is the Claude Code equivalent of `.github/copilot-instructions.md`. It is automatically loaded by Claude Code when working in this repository. Task-specific prompts are in the `prompts/` directory.
